...
const SvgComponent = (props: SvgProps) => (
  ...
  >
    ...
    <Defs>
      ...
      >
        <Stop offset={0.08} stopColor="#0C92DE" />
        <Stop offset={0.608} stopColor="#2EE5FB" />
      </LinearGradient>
      <LinearGradient
        id="b"
        x1={1041.77}
        ...
        gradientUnits="userSpaceOnUse"
      >
        <Stop stopColor="#1CBAEC" />
        <Stop offset={1} stopColor="#095A88" />
      </LinearGradient>
      <LinearGradient
        id="c"
        x1={1041.77}
